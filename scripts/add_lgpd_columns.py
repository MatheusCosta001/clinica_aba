"""Helper to add LGPD-related columns if missing.
Run locally: `python scripts/add_lgpd_columns.py` after activating your venv.
This is a simple migration helper that executes ALTER TABLE statements when needed.
"""
...
if __name__ == '__main__':
    with app.app_context():
        ...
        # relatorios table (create if not exists)
        try:
            insp = inspect(engine)
